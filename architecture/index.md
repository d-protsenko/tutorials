...
Java-классы стратегий должны реализовывать интерфейс IResolveDependencyStrategy.

Имя класса стратегии, реализующего только интерфейс IResolveDependencyStrategy,
...
интерфейса IResolveDependencyStrategy, должно соответствовать общим правилам
